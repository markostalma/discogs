...
class DiscogsSpider(scrapy.Spider):
    ...
    def album_links(self, response):
        ...
        albumItems.add_xpath('albumGenre', '//div[text()="Genre:"]/following-sibling::div[1]/a/text()')
        albumItems.add_xpath('albumStyle', '//div[text()="Style:"]/following-sibling::div[1]/a/text()')
